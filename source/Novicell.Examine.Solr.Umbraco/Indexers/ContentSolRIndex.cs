...
{
    public class ContentSolRIndex : SolRUmbracoIndex , IUmbracoContentIndex
    {
        public ContentSolRIndex(string name, SolrConfig connectionConfiguration, IProfilingLogger profilingLogger,  
